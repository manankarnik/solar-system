...
<template>
  <PlanetHeader
    model="/solar-system/models/earth.glb"
    modelAlt="Earth"
    :info="info"
  />
  <ArticleItem
    id="mid"
    backgroundImage="linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/solar-system/images/earthbg.jpg')"
    title="Earth"
    :article="article"
  />
</template>
  ...
  data() {
    return {
        ...
        left: [
          {
            ...
            text: "Aphelion:<br>152,100,000 km<br><br>Perihelion:<br>147,095,000 km",
          },
          {
          ...
          {
            heading: "Mass",
            text: "5.97237×10<sup>24</sup> kg",
          },
          {
            heading: "Volume",
            text: "1.08321×10<sup>12</sup> km<sup>3</sup>",
          },
        ],
        right: [
          {
            heading: "Average Density",
            text: "5.514 g/cm<sup>3</sup>",
          },
          {
            heading: "Surface Area",
            text: "510,072,000 km<sup>2</sup>",
          },
          {
      ...
      article: [
        ...
        {
          heading: "Origin of Life and Evolution",
          text: [
