...
<template>
  <PlanetHeader
    model="/solar-system/models/venus.glb"
    modelAlt="Venus"
    :info="info"
  />
  <ArticleItem
    id="mid"
    backgroundImage="linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/solar-system/images/venusbg.jpg')"
    title="Venus"
    :article="article"
  />
</template>
  ...
  data() {
    return {
        ...
        left: [
          {
            ...
            text: "Aphelion:<br>108,939,000 km<br><br>Perihelion:<br>107,477,000 km",
          },
          {
          ...
          {
            heading: "Mass",
            text: "	4.8675×10<sup>24</sup> kg",
          },
          {
            heading: "Volume",
            text: "9.2843×10<sup>11</sup> km<sup>3</sup>",
          },
        ],
        right: [
          {
            heading: "Average Density",
            text: "5.243 g/cm<sup>3</sup>",
          },
          {
            heading: "Surface Area",
            text: "4.6023×10<sup>8</sup> km<sup>2</sup>",
          },
          {
      ...
      article: [
        ...
        {
          heading: "Atmosphere and Climate",
          text: [
