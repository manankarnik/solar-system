...
<template>
  <PlanetHeader
    model="/solar-system/models/pluto.glb"
    modelAlt="Pluto"
    :info="info"
  />
  <ArticleItem
    id="mid"
    backgroundImage="linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/solar-system/images/plutobg.jpg')"
    title="Pluto"
    :article="article"
  />
</template>
        ...
        left: [
          {
            ...
            text: "Aphelion:<br>7.37593 billion km<br><br>Perihelion:<br>4.43682 billion km",
          },
          {
          ...
          {
            heading: "Mass",
            text: "1.303×10<sup>22</sup> kg",
          },
          {
            heading: "Volume",
            text: "7.057×10<sup>9</sup> km<sup>3</sup>",
          },
        ],
        right: [
          {
            heading: "Average Density",
            text: "1.854 gm/cm<sup>3</sup>",
          },
          {
            heading: "Surface Area",
            text: "1.664794×10<sup>7</sup> km<sup>2</sup>",
          },
          {
