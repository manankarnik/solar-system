...
<template>
  <PlanetHeader model="/models/mercury.glb" modelAlt="Mercury" :info="info" />
  <ArticleItem
    id="mid"
    backgroundImage="linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/images/mercurybg.jpg')"
    title="Mercury"
    :article="article"
  />
</template>
        ...
        left: [
          {
            ...
            text: "Aphelion:<br>69,816,900 km<br><br>Perihelion:<br>46,001,200 km",
          },
          {
          ...
          {
            heading: "Mass",
            text: "3.3011×10<sup>23</sup> kg",
          },
          {
            heading: "Volume",
            text: "6.083×10<sup>10</sup> km<sup>3</sup>",
          },
        ],
        right: [
          {
            heading: "Average Density",
            text: "5.427 g/cm<sup>3<sup>",
          },
          {
            heading: "Surface Area",
            text: "7.48×10<sup>7</sup> km<sup>2</sup>",
          },
          {
