...
<template>
  <PlanetHeader model="/models/neptune.glb" modelAlt="Neptune" :info="info" />
  <ArticleItem
    id="mid"
    backgroundImage="linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/images/neptunebg.jpg')"
    title="Neptune"
    :article="article"
  />
</template>
    ...
    return {
      info: {
        left: [
          ...
          {
            heading: "Mass",
            text: "1.02413×10<sup>26</sup> kg",
          },
          {
            heading: "Volume",
            text: "6.253×10<sup>13</sup> km",
          },
        ],
        right: [
          {
            heading: "Average Density",
            text: "1.638 g/cm<sup>3</sup>",
          },
          {
            heading: "Surface Area",
            text: "7.6187×10<sup>9</sup> km<sup>2</sup>",
          },
          {
